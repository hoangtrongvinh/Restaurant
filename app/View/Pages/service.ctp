...
$this->Html->script('jssor', array('inline' => false));
$this->Html->script('jssor.slider', array('inline' => false));
?>
<style>
    .appicon01
    {
...
<?php
$this->assign('StyleContent', 'font-family:Arial, Verdana;background-color:#fff; background-image: url(/img/back.jpg);')
?>
<div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 800px; height: 350px; overflow: visible;
margin-left: 10%;">
    <!-- Loading Screen -->
