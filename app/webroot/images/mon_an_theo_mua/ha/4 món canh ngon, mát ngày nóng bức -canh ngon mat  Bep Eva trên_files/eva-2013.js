...
getElement(elementID+'_sub').innerHTML='<div style="'+elementStyle+'background-color:black;z-index:1001;-moz-opacity:0.8;opacity:.80;filter:alpha(opacity=80);" onclick="closePopBanner(\''+elementID+'_sub\')"></div>';getElement(elementID+'_sub').innerHTML+='<div style="'+elementSubStyle+'"><embed type="application/x-shockwave-flash" src="../../../../layout/mon_an_theo_mua/ha/4 món canh ngon, mát ngày nóng bức -canh ngon mat  Bep Eva trên_files/'+path+bannerName+'" quality="high" allowscriptaccess="always" wmode="transparent" width="100%" height="100%" flashvars="divID='+elementID+'_sub" /></div>';break;case'takeover':default:getElement(elementID+'_sub').innerHTML='<div style="position:absolute;top:0%;left:'+(c_width-v_width)/2+'px;width:'+v_width+'px;height:'+v_height+'px;"><embed type="application/x-shockwave-flash" src="../../../../layout/mon_an_theo_mua/ha/4 món canh ngon, mát ngày nóng bức -canh ngon mat  Bep Eva trên_files/'+path+bannerName+'" quality="high" allowscriptaccess="always" wmode="transparent" width="100%" height="100%" flashvars="divID='+elementID+'_sub" /></div>';break;}}
...
function fw24h_getFlash(object){var str='<object id="swf_'+object.name+'" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0" border="0" height="'+object.height+'" width="'+object.width+'"><param name="movie" value="../../../../layout/mon_an_theo_mua/ha/4 món canh ngon, mát ngày nóng bức -canh ngon mat  Bep Eva trên_files/'+object.bannerPath+'"><param name="AllowScriptAccess" value="always"><param name="quality" value="High"><param name="wmode" value="transparent"><embed src="../../../../layout/mon_an_theo_mua/ha/4 món canh ngon, mát ngày nóng bức -canh ngon mat  Bep Eva trên_files/'+object.bannerPath+'" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" wmode="transparent" allowscriptaccess="always" height="'+object.height+'" width="'+object.width+'"></object>';if(_chrome_version()>=27){var str='<embed src="../../../../layout/mon_an_theo_mua/ha/4 món canh ngon, mát ngày nóng bức -canh ngon mat  Bep Eva trên_files/'+object.bannerPath+'" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" wmode="transparent" allowscriptaccess="always" height="'+object.height+'" width="'+object.width+'">';}
return str;}
function fw24h_getFloatFlash(object,flash_vars){var str='<object id="swf_'+object.name+'" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0" border="0" height="100%" width="100%"><param name="movie" value="../../../../layout/mon_an_theo_mua/ha/4 món canh ngon, mát ngày nóng bức -canh ngon mat  Bep Eva trên_files/'+object.bannerPath+object.name1+'"><param name="AllowScriptAccess" value="always"><param name="quality" value="High"><param name="wmode" value="transparent"><param name="flashVars" value="'+flash_vars+'"><embed src="../../../../layout/mon_an_theo_mua/ha/4 món canh ngon, mát ngày nóng bức -canh ngon mat  Bep Eva trên_files/'+object.bannerPath+object.name1+'" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" wmode="transparent" allowscriptaccess="always" height="100%" width="100%" flashVars="'+flash_vars+'"></object>';if(_chrome_version()>=27){var str='<embed src="../../../../layout/mon_an_theo_mua/ha/4 món canh ngon, mát ngày nóng bức -canh ngon mat  Bep Eva trên_files/'+object.bannerPath+object.name1+'" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" wmode="transparent" allowscriptaccess="always" height="100%" width="100%" flashVars="'+flash_vars+'">';}
return str;}
...
bannerStr[i]='';if(bannerArr.hyperlink!=""&&bannerArr.bannerType=="IMAGE"){bannerStr[i]+='<a href="../../../../layout/mon_an_theo_mua/ha/4 món canh ngon, mát ngày nóng bức -canh ngon mat  Bep Eva trên_files/'+bannerArr.hyperlink+'" '+((bannerArr.popup)?'target="_blank"':'')+'>';}
...
if(bannerArr.bannerType=="TEXT"){bannerStr[i]+='<iframe width="'+bannerArr.width+'" height="'+bannerArr.height+'" src="../../../../layout/mon_an_theo_mua/ha/4 món canh ngon, mát ngày nóng bức -canh ngon mat  Bep Eva trên_files/'+bannerArr.bannerPath+'" marginwidth="0" marginheight="0" scrolling="no" frameborder="0"></iframe>'}
...
result+='</select></TD>';}
else{if(this.isShowYearNavigation){result+='<TD CLASS="'+this.cssPrefix+'cpMonthNavigation" WIDTH="10"><A CLASS="'+this.cssPrefix+'cpMonthNavigation" HREF="../../../../layout/mon_an_theo_mua/ha/4 món canh ngon, mát ngày nóng bức -canh ngon mat  Bep Eva trên_files/'+refreshLink+'('+this.index+','+last_month+','+last_month_year+');"><</A></TD>';result+='<TD CLASS="'+this.cssPrefix+'cpMonthNavigation" WIDTH="58"><SPAN CLASS="'+this.cssPrefix+'cpMonthNavigation">'+this.monthNames[month-1]+'</SPAN></TD>';result+='<TD CLASS="'+this.cssPrefix+'cpMonthNavigation" WIDTH="10"><A CLASS="'+this.cssPrefix+'cpMonthNavigation" HREF="../../../../layout/mon_an_theo_mua/ha/4 món canh ngon, mát ngày nóng bức -canh ngon mat  Bep Eva trên_files/'+refreshLink+'('+this.index+','+next_month+','+next_month_year+');">></A></TD>';result+='<TD CLASS="'+this.cssPrefix+'cpMonthNavigation" WIDTH="10">&nbsp;</TD>';result+='<TD CLASS="'+this.cssPrefix+'cpYearNavigation" WIDTH="10"><A CLASS="'+this.cssPrefix+'cpYearNavigation" HREF="../../../../layout/mon_an_theo_mua/ha/4 món canh ngon, mát ngày nóng bức -canh ngon mat  Bep Eva trên_files/'+refreshLink+'('+this.index+','+month+','+(year-1)+');"><</A></TD>';if(this.isShowYearNavigationInput){result+='<TD CLASS="'+this.cssPrefix+'cpYearNavigation" WIDTH="36"><INPUT NAME="cpYear" CLASS="'+this.cssPrefix+'cpYearNavigation" SIZE="4" MAXLENGTH="4" VALUE="'+year+'" onBlur="'+refresh+'('+this.index+','+month+',this.value-0);"></TD>';}
else{result+='<TD CLASS="'+this.cssPrefix+'cpYearNavigation" WIDTH="36"><SPAN CLASS="'+this.cssPrefix+'cpYearNavigation">'+year+'</SPAN></TD>';}
result+='<TD CLASS="'+this.cssPrefix+'cpYearNavigation" WIDTH="10"><A CLASS="'+this.cssPrefix+'cpYearNavigation" HREF="../../../../layout/mon_an_theo_mua/ha/4 món canh ngon, mát ngày nóng bức -canh ngon mat  Bep Eva trên_files/'+refreshLink+'('+this.index+','+month+','+(year+1)+');">></A></TD>';}
else{result+='<TD CLASS="'+this.cssPrefix+'cpMonthNavigation" WIDTH="22"><A CLASS="'+this.cssPrefix+'cpMonthNavigation" HREF="../../../../layout/mon_an_theo_mua/ha/4 món canh ngon, mát ngày nóng bức -canh ngon mat  Bep Eva trên_files/'+refreshLink+'('+this.index+','+last_month+','+last_month_year+');"><<</A></TD>\n';result+='<TD CLASS="'+this.cssPrefix+'cpMonthNavigation" WIDTH="100"><SPAN CLASS="'+this.cssPrefix+'cpMonthNavigation">'+this.monthNames[month-1]+' '+year+'</SPAN></TD>\n';result+='<TD CLASS="'+this.cssPrefix+'cpMonthNavigation" WIDTH="22"><A CLASS="'+this.cssPrefix+'cpMonthNavigation" HREF="../../../../layout/mon_an_theo_mua/ha/4 món canh ngon, mát ngày nóng bức -canh ngon mat  Bep Eva trên_files/'+refreshLink+'('+this.index+','+next_month+','+next_month_year+');">>></A></TD>\n';}}
